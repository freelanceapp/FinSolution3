...
import com.semicode.findsolution.databinding.SpinnerCategoryRowBinding;
...
public class SpinnerSubCategoryAdapter extends BaseAdapter {
    ...
    public SpinnerSubCategoryAdapter(List<SingleSubCategoryModel> list, Context context) {
        this.list = list;
